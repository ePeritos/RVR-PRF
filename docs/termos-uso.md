...
A PRF não será responsabilizada por interrupções ou falhas decorrentes de:
...
As comunicações oficiais relacionadas a estes Termos serão realizadas através de:
