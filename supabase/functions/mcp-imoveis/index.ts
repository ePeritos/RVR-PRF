...
const BASIC_FIELDS = 'id, nome_da_unidade, endereco, unidade_gestora, tipo_de_unidade, ano_caip, estado_de_conservacao, area_construida_m2, area_do_terreno_m2, rip, matricula_do_imovel, situacao_do_imovel, coordenadas, nota_global, nota_para_adequacao, nota_para_manutencao';
